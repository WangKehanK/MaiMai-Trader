    ...
    return Scaffold(
      ...
      body: Scrollbar(
        child: FutureBuilder(
                      ...
                      CustomPadding(
                          ...
                          child: Row(
                              children: Tag().generator(
                                  freeShipping: true, condition: "New"))),
                      CustomPadding(
                        pixelMultiple: 3,
                        rowPadding: true,
                        child: Row(children: <Widget>[
          ...
          future: GetProductDetail().getProductDetail(),
        ),
      ),
    );
  }
...
class GetProductDetail {
  ...
  Future<List<ProductModel>> getProductDetail() async {
    ...
    if (res.statusCode == 200) {
      ...
      return data.map((employees) => new ProductModel.fromJson(employees)).toList();
    } else {
